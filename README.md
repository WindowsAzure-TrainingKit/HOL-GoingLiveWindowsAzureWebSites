...
If you find any issues with this hands-on lab that you can't fix, feel free to report them in the [issues](https://github.com/WindowsAzure-TrainingKit/HOL-GoingLiveWindowsAzureWebSites/issues) section of this repository.